	   ...
	   void save() {
		   try{
	          ...
	          //현재 시간구하기 초까지...
	            ...
	            bufferedWriter.write("최종 결과 시점:"+now);
	            bufferedWriter.newLine(); 
	            bufferedWriter.write("<<< 현재 내 팀 기록 >>>");
	            bufferedWriter.newLine(); 
	            bufferedWriter.write("내팀명 : "+teamName[3]);
	            bufferedWriter.newLine();	  		   
	            bufferedWriter.write("승리    무승부    패배");
	            bufferedWriter.newLine();
	            bufferedWriter.write(" "+win+"     "+draw+"    "+loss);
	            bufferedWriter.newLine();	  		   
	            bufferedWriter.write("<<< 다른 팀 기록 >>>");
	  			for(int i=0; i<3;i++)
	  			{			
	  				bufferedWriter.write("팀명 : "+teamName[i]);
	  				bufferedWriter.newLine();
	  				bufferedWriter.write("승리    무승부    패배");
	  				bufferedWriter.newLine();
